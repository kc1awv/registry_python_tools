...
parser.add_argument('-u', '--url', default='https://dvref.com/mrefd/json/?format=json', help="URL to lookup mrefd reflector JSON")
...
data = pd.json_normalize(response, record_path=['reflectors'])
